...
/**
 * Driver for "MSXML 6.0"
 *
 * @author Viktor Mašíček <viktor@masicek.net>
 */
class MSXML60ProcessorDriver extends AProcessorDriver
{
	...
	public function isAvailable()
	{
		...
		{
			exec('cscript //nologo "' . __DIR__ . '\MSXMLAvailability.js" "6.0"', $output);
	...
	{
		$commandTemplate = 'cscript //nologo "[PROCESSORS]\MSXML\msxml.js" "[INPUT]" "[XSLT]" "[OUTPUT]" "[ERROR]" "6.0"';
