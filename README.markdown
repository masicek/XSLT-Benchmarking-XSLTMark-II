...
Testes are generated by command ```run.bat -g```.

##### Modify element - Rename #####

There are the list of files of generated test ```Modify element - Rename```:
...
There are contens of files of test ```Modify element - Rename```.
